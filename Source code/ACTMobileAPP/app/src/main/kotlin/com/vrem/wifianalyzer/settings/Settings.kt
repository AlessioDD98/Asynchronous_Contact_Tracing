...
class Settings(private val repository: Repository) {
    ...
    fun posScanSpeed(): Int {
        val defaultValue = repository.stringAsInteger(R.string.scan_pos_speed_default, SCAN_POS_SPEED_DEFAULT)
        val scanSpeed = repository.stringAsInteger(R.string.scan_pos_speed_key, defaultValue)
        return scanSpeed
    }

    fun distance(): Int {
        val defaultValue = repository.stringAsInteger(R.string.distance_default, DISTANCE_DEFAULT)
        val distance = repository.stringAsInteger(R.string.distance_key, defaultValue)
        return distance
    }
    ...
    companion object {
        ...
        private const val SCAN_POS_SPEED_DEFAULT = 5
        private const val DISTANCE_DEFAULT = 30
    }
