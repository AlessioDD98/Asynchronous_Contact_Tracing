...
enum class MainContext {
    ...
    val permissionService: PermissionService get() = PermissionService(mainActivity)

    val mA:MainActivity get()=mainActivity
    ...
    fun initialize(activity: MainActivity, largeScreen: Boolean) {
        ...
        if(mode.equals("act")){
            scannerService=ACTmakeScannerService(mainActivity, wiFiManagerWrapper, Handler(Looper.getMainLooper()), settings )
