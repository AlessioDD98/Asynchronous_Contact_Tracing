...
public final class AccessPointViewCompleteBinding implements ViewBinding {
  ...
  private AccessPointViewCompleteBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout attachPopup, @NonNull TextView capabilities, @NonNull TextView channel,
      ...
      @NonNull TextView tab, @NonNull TextView vendorShort, @NonNull ImageView wiFiStandardImage,
  ...
  public static AccessPointViewCompleteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.capabilities;
      TextView capabilities = ViewBindings.findChildViewById(rootView, id);
      ...
      ImageView securityImage = ViewBindings.findChildViewById(rootView, id);
      ...
      return new AccessPointViewCompleteBinding((LinearLayout) rootView, attachPopup, capabilities,
          channel, channelFrequencyRange, distance, groupIndicator, level, levelImage,
          primaryFrequency, securityImage, ssid, tab, vendorShort, wiFiStandardImage, width);
    }
